...
// store/editorStore.ts
var useEditorStore = create()((set, get) => __spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, createTimelineSlice(set, get)), createPlaybackSlice(set)), createEffectsSlice(
  set,
  get
      ...
      children: /* @__PURE__ */ jsxs12("div", { className: "flex gap-4 h-full", children: [
        /* @__PURE__ */ jsxs12("div", { className: "flex-1 min-w-0 overflow-y-auto", children: [
          ...
          /* @__PURE__ */ jsxs12("div", { className: "mb-2 flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxs12("span", { className: "text-xs tabular-nums", style: { color: "var(--kt-text-secondary)", minWidth: 28 }, children: [
...
function VoiceRecorder() {
  ...
  const freezeStartRef = useRef9(0);
